  ...
  return (
    <React.Fragment>
      <TableRow style={{ position: 'relative' }}>
        ...
        <TableCell class="lowercell" align="left" >{task.payment}  <IconButton
          aria-label="open review dialog"
          onClick={() => setReviewVisible(true)}
          style={{ color: 'violet', marginLeft: '10px' }}
        >
          <RateReviewIcon />
        </IconButton> {reviewVisible && <ReviewDialog onClose={() => setReviewVisible(false)} />}
       </TableCell>
